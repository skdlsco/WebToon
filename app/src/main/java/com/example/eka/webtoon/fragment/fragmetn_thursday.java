...
public class fragmetn_thursday extends Fragment {
    ArrayList<Item> items = new ArrayList<>();

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_thursday, null);

        String url = "comic.naver.com/webtoon/weekdayList.nhn?week=thu";

        ItemThread itemThread = new ItemThread(url);

        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.listthursday);
