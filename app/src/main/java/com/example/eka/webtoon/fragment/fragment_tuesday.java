...
public class fragment_tuesday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.fragment_tuesday, null);

        String url = "comic.naver.com/webtoon/weekdayList.nhn?week=tue";

        ItemThread itemThread = new ItemThread(url);

        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.listtuesday);
